...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='assistant_teacher', to='accounts.Teacher', verbose_name='assistant teacher'),
        ),
        migrations.AddField(
            model_name='course',
            name='created_by',
        ...
        migrations.AddField(
            model_name='course',
            name='students',
            field=models.ManyToManyField(to='accounts.Student', verbose_name='students'),
        ),
        migrations.AddField(
            model_name='course',
            name='teacher',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='classrooms.Course', verbose_name='course'),
        ),
        migrations.AddField(
            model_name='classroom',
            name='created_by',
        ...
        migrations.AddField(
            model_name='classroom',
            name='groups',
            field=models.ManyToManyField(related_name='course_classroom_groups', through='classrooms.ClassroomGroup', to='classrooms.Course', verbose_name='groups'),
        ),
        migrations.AddField(
            model_name='classroom',
            name='modified_by',
