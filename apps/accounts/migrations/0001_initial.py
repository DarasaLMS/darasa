    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None, verbose_name='Phone number')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Email address')),
                ('enroll_mode', models.CharField(choices=[('enroll_all', "Enroll to all courses per student's educational stage"), ('choose_to_enroll', 'Choose to enroll to a course')], default='choose_to_enroll', max_length=32, verbose_name='course enroll mode')),
