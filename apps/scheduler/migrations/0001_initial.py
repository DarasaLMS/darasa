    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.Calendar', verbose_name='calendar')),
                ...
                ('rule', models.ForeignKey(blank=True, help_text="Select '----' for a one time only event.", null=True, on_delete=django.db.models.deletion.SET_NULL, to='scheduler.Rule', verbose_name='rule')),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, verbose_name='created on')),
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='updated on')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduler.Event', verbose_name='event')),
            ],
            options={
